            ...
            <div class="menu-top">
                ...
                if ( has_nav_menu( 'expanded' ) ) {
                    ...
                    <nav class="expanded-menu<?php echo esc_attr( $expanded_nav_classes ); ?>" aria-label="<?php echo esc_attr_x( 'Expanded', 'menu', 'twentytwenty' ); ?>" role="navigation">
                        ...
                        <ul class="modal-menu reset-list-style">
                            <?php
                            if ( has_nav_menu( 'expanded' ) && is_user_logged_in() ) {
                                wp_nav_menu(
                                    array(
                                        'container'      => '',
                                        'items_wrap'     => '%3$s',
                                        'show_toggles'   => true,
                                        'theme_location' => 'expanded_logged_in',
                                    )
                                );
                            } else {
                                wp_nav_menu(
                ...
                if ( 'expanded' !== $mobile_menu_location ) {
                    ...
                    <nav class="mobile-menu" aria-label="<?php echo esc_attr_x( 'Mobile', 'menu', 'twentytwenty' ); ?>" role="navigation">
                        ...
                        <?php
                        if ( $mobile_menu_location && is_user_logged_in() ) {
                            ...
                            wp_nav_menu(
                                array(
                                    ...
                                    'items_wrap'     => '%3$s',
                                    'show_toggles'   => true,
                                    'theme_location' => 'mobile_logged_in',
                                )
                            );

                        } elseif ( $mobile_menu_location ) {
