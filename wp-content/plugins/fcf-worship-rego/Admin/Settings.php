...
class Settings extends SettingsBase
{
    ...
    {
      add_menu_page('Worship Registration Options','Worship','manage_options',$this->menuSlug,array($this, 'renderSettingsPageContent'),'dashicons-smiley',81);
      add_submenu_page( 'worship-rego', 'Worship Options', 'Options', 'manage_options', 'worship-options', array($this, 'renderSettingsPageOptions') );
    }
